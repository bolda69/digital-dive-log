...
| M4 | AI Gemini Integration | POST /api/upload endpoint, Gemini SDK setup, schema parsing and validation | M3 | PLANNED |
| M5 | Frontend Core & Services | Angular project structure, routing, HTTP service (DiveService) | None | PLANNED |
